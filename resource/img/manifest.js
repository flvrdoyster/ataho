// resource/img/ 이미지 갤러리 데이터. caption/source/modified는 직접 편집한다.
...
window.RESOURCE_IMG_MANIFEST = {
  "cover-kitan.png": {
    "caption": "환세희담 메인 일러스트 (커버)",
    "source": "환세희담 매뉴얼",
    "modified": 1
  },
  "illust-kitan.png": {
    "caption": "환세희담 메인 일러스트",
    "source": "환세희담 매뉴얼",
    "modified": 2
  },
  ...
  "ds04.png": {
    "caption": "환세풍광전 DS 메뉴 일러스트",
    "source": "디스크 스테이션 Vol.4",
    "modified": 0
  },
  "illust-hukyou.png": {
    "caption": "환세풍광전 메인 일러스트",
    "source": "디스크 스테이션 Vol.4",
    "modified": 2
  },
  "illust-kaitou.png": {
    "caption": "환세쾌도전 메인 일러스트",
    "source": "디스크 스테이션 Vol.8",
    "modified": 2
  },
  "ds10.png": {
    "caption": "환세포물장 DS 메뉴 일러스트",
    "source": "디스크 스테이션 Vol.10",
    "modified": 0
  },
  "illust-torimono.png": {
    "caption": "환세포물장 메인 일러스트",
    "source": "디스크 스테이션 Vol.10",
    "modified": 2
  },
  "ds14.png": {
    "caption": "환세취호전 DS 메뉴 일러스트",
    "source": "디스크 스테이션 Vol.14",
    "modified": 0
  },
  "illust-suiko.png": {
    "caption": "환세취호전 메인 일러스트",
    "source": "디스크 스테이션 Vol.14",
    "modified": 2
  },
  "ds20.png": {
    "caption": "환세패유기 DS 메뉴 일러스트",
